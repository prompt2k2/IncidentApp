...
class Incident(models.Model):
    ...
    imme_action = models.CharField(verbose_name='Immediate action taken',max_length=2000, null=True, blank=True)
    ...
    long_action = models.CharField(verbose_name='Long term action taken', max_length=2600, null=True, blank=True)
    ...
    imme_action2 = models.CharField(verbose_name='Second Immediate action taken',max_length=2000, null=True, blank=True)
