...
class Incident(models.Model):
    ...
    incident_area_detail = models.CharField(verbose_name='Incident Area description', max_length=2500, null=True, blank=True)
    direct_cause = models.CharField(verbose_name='Direct Cause of Incident', max_length=2000, null=True, blank=True)
    root_cause = models.CharField(verbose_name='Root Cause of Incident',max_length=1400, null=True, blank=True)
    imme_action = models.CharField(verbose_name='Immediate action taken',max_length=1200, null=True, blank=True)
    ...
    imme_action2 = models.CharField(verbose_name='Second Immediate action taken',max_length=2200, null=True, blank=True)
    ...
    long_action2 = models.CharField(verbose_name='Second Long term action taken', max_length=2600, null=True, blank=True)
