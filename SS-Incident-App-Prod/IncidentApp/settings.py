...
STATIC_ROOT = os.path.join(BASE_DIR, 'IncidentApp/staticfiles')#C:/Users/IT Manager/DEV/SS-Incident-App-Prod/SS-Incident-App-Prod/static
STATIC_URL = '/static/'

MEDIA_ROOT = os.path.join(BASE_DIR, 'IncidentApp/media')
MEDIA_URL = '/media/'
